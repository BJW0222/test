...
expect << EOF
spawn scp -o "StrictHostKeyChecking=no" /home/phoenix/token/token.txt phoenix@20.20.50.10:/home/phoenix/token.txt
expect "password:" {send "VMware1!\r"}
expect eof

spawn scp -o "StrictHostKeyChecking=no" /home/phoenix/token/token.txt phoenix@20.20.50.20:/home/phoenix/token.txt
expect "password:" {send "VMware1!\r"}
expect eof

spawn scp -o "StrictHostKeyChecking=no" /home/phoenix/token/token.txt phoenix@20.20.50.30:/home/phoenix/token.txt
expect "password:" {send "VMware1!\r"}
expect eof

spawn scp -o "StrictHostKeyChecking=no" /home/phoenix/token/token.txt phoenix@20.20.50.40:/home/phoenix/token.txt
expect "password:" {send "VMware1!\r"}
expect eof
EOF
